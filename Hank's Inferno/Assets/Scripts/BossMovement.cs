                    ...
                    */
                    ...
                    if (Physics2D.BoxCast(transform.position, box_mask, 0, -transform.up, box_distance, ground_layer) && rb.velocity.y <= 0f)
                    {
                        if (grounded == false)
                        {
                            ...
                            GameObject _bullet = Instantiate(enemy_bullet, new Vector3(transform.position.x, GameObject.Find("Main Camera").GetComponent<CameraController>().camera_y - 1.5f, transform.position.z), Quaternion.identity);
                            ...
                            GameObject _bullet2 = Instantiate(enemy_bullet, new Vector3(transform.position.x, GameObject.Find("Main Camera").GetComponent<CameraController>().camera_y - 1.5f, transform.position.z), Quaternion.identity);
